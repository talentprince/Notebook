...
public class NotebookProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "org.weyoung.notebook.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_NOTEDATA = 0;
    private static final int URI_TYPE_NOTEDATA_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, NotedataColumns.TABLE_NAME, URI_TYPE_NOTEDATA);
        URI_MATCHER.addURI(AUTHORITY, NotedataColumns.TABLE_NAME + "/#", URI_TYPE_NOTEDATA_ID);
    }

    protected NoteBookSQLHelper mNoteBookSQLHelper;
    ...
    public boolean onCreate() {
        ...
        mNoteBookSQLHelper = NoteBookSQLHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_NOTEDATA:
                return TYPE_CURSOR_DIR + NotedataColumns.TABLE_NAME;
            case URI_TYPE_NOTEDATA_ID:
                return TYPE_CURSOR_ITEM + NotedataColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mNoteBookSQLHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mNoteBookSQLHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mNoteBookSQLHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mNoteBookSQLHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mNoteBookSQLHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_NOTEDATA:
            case URI_TYPE_NOTEDATA_ID:
                res.table = NotedataColumns.TABLE_NAME;
                res.tablesWithJoins = NotedataColumns.TABLE_NAME;
                res.orderBy = NotedataColumns.DEFAULT_ORDER;
                break;
